...
const Location = () => {
  ...
  return (
    <div className="bg-gray-900 p-8" id="location">
      <div className="mb-10 flex flex-col items-center">
        ...
        <div className="w-32 h-1 bg-purple-600 mt-4 rounded-full"></div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-3 mx-auto">
          <div
            className="bg-gray-800/60 rounded-lg overflow-hidden shadow-lg border border-gray-800"
      ...
      <div className="mt-8 text-center">
        <a href="#contact" className="px-8 py-3 w-56 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-medium hover:from-purple-700 hover:to-indigo-700 active:from-purple-800 active:to-indigo-800 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto">
          <MapPin size={18} />
